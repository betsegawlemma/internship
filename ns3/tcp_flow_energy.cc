...
/*
   ...
   To run the script use the follwoing example

  ./waf --run "tcp_flow_energy  --packetSize=1472 --dataRate=10Mbps --numPackets=849"
...
main (int argc, char *argv[])
{
  ...
  Ptr<Socket> ns3TCPSocket1 = Socket::CreateSocket (n0n1.Get (0), TcpSocketFactory::GetTypeId ());
