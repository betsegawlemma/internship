...
/*
   ...
   ./waf --run "2flow_energy_same  --packetSize=1472 --dataRate=10Mbps --numPackets=849"
...
main (int argc, char *argv[])
{
  ...
  Ptr<Socket> ns3UDPSocket2 = Socket::CreateSocket (n0n1.Get (0), UdpSocketFactory::GetTypeId ());
