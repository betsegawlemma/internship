...
Due to the emergence of new echnologies such as IoT, the number of devices connected to the data-center infrastructures is rapidly increasing. In response to this growing trend the data-centers are also expanding. This expansion led to a major energy consumption concern. Researchers are working on to find solution to the energy consumption issue by designing and running experiments on real network and test-bed environments. These two approachs are limited interms of availabilty, flexibility and cost for conducting large-scale energy consumption estimation experiments. The other viable approach in the context of large-scale networks is the use of simulation software. Currently proposed simulation software for energy estimation are in the category of packet-level simulators. The main problem of this kind of simulators is that they fail to scale well in the area of large-scale networks. In this paper we have proposed a reasonably accurate and scalable flow-level simulator in the context of SimGrid, a large-scale distributed network simulator. Our validation and scalability experiments show that
}
% Acknowledgements
% ------------------------------------------------------------------
