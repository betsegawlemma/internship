...
\todo[inline]{I would rename this chapter 'Experimental Methodology' and I would add a section title at the beginning for the first paragraphs: 'Common approaches'}
...
\todo[inline]{You need to cite the Mahadevan paper}
...
\todo[inline]{You really took 1ns for the delay between nodes? This is really really small. Typical delay between servers in the same rack connected to the same switch are on the order of few milliseconds.}
...
\todo[inline]{You could also put the graphs, they are nice.}
