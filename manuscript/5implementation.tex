...
\todo[inline]{I don't remember if you gave details before this chapter about the implementation of networks in SimGrid, but if you didn't I think it is important to explain here that SimGrid does not represent network nodes (contrarily to NS-3), only links which share bandwidth among flows.}
