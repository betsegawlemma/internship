...
Running simulation experiments in SimGrid involves creating three files: the C/C++ Simulation Script, XML file for specifying the simulated platform  and XML file for specifying . 
