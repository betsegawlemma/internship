...
\todo[inline]{Is there something missing here? It seems weird to have a section with only one paragraph saying that we are not going to talk about something here.}
