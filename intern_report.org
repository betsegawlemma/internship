...
**** Questions
    ...
    #+begin_src latex
       ...
       where, $EPI_equipment$ is energy proportionality index. Which is computed by dividing the slope of the ideal proportional line to the measured line as shown in [[benchmark]]
