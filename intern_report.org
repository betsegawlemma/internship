...
#+BEGIN_SRC R :results output graphics dir:~/internship :var input="data/eco_val_100.csv" :file figures/ecof_val_100.png :exports both
library(ggplot2)
...
#+BEGIN_SRC R :results output graphics dir:~/internship :var input="data/eco_val_576.csv" :file figures/ecof_val_576.png :exports both
library(ggplot2)
...
#+BEGIN_SRC R :results output graphics dir:~/internship :var input="data/eco_val_1000.csv" :file figures/ecof_val_1000.png :exports both
library(ggplot2)
...
#+BEGIN_SRC R :results output graphics dir:~/internship :var input="data/eco_val_1500.csv" :file figures/ecof_val_1500.png :exports both
library(ggplot2)
