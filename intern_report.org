...
- The objective of this experiment is to study the relationship between data transfer rate or bandwidth and energy consumption and 
based on the result, to propose flow-level analytical model which estimate energy consumption of large-scale networks
