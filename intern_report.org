...
** Bibliography 
     ...
     2. ECOFEN: an End-to-end energy Cost mOdel and simulator For Evaluating power consumption in large-scale Networks
      ...
      In addition, though the authors simulated the energy saving techniques such as ON/FF technique in their experiments, their proposed model did not include energy saving technique as one of its parameter. 
