...
*** Week 4 March
**** Experiment - Power consumption vs 1-flow UDP traffic, Packet_Size = 1472, ([[file:ns3/1flow_energy.cc]])
...
**** Experiment - Power consumption vs 1-flow TCP traffic, packet_size=1472, ([[file:ns3/tcp_flow_energy.cc]])
...
**** Experiment - Power consumption of 2-flow UDP traffic: packet size = 1472, flow direction = same ([[file:ns3/2flow_energy_same.cc]])
...
| Flow | Traffic (Mbps) | Power_consumption (watt) | Power_Consumption - Idle |
|------+----------------+--------------------------+--------------------------|
|    0 |              0 |                    8.038 |                        0 |
