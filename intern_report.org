...
#+END_SRC   
***** Extract simgrid's data
#+CALL: extract_sg_data_3(input_file="data/ex12_sg_1L2F.raw", output_file="data/ex12_sg_1L2F.csv",flow=2)
***** Extract ecofen's data
#+CALL: extract_ns3_data_5(input_file="data/ex12_ns3_1L2FL.raw", output_file="data/ex12_ns3_1L2FL.csv",flow=2)
***** Compare results
