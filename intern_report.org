...
#+BEGIN_SRC R :results output :var validation=validation :exports both 
   ...
   cat("Difference in percentage is:",(5250.815 - 5485.110)/100)
#+END_SRC
...
Difference in percentage is: -2.34295
#+end_example
...
<<format_theme>>
   ...
   geom_point(aes(y = ElapsedSecns3, colour = "ECOFEN"),size=1.3)+
   geom_point(aes(y = ElapsedSecsg, colour = "SimGrid"),size=1.3)+
   ...
   xlab(label="Path size between SRC and DST nodes")+
   scale_colour_Publication()+
   theme_Publication()
#+END_SRC
...
ex16_ns3 = read.csv("data/perfLink1_ns3_F2.csv", header=T)
   ...
   sg_ns3 = cbind(ex16_ns3,ex16_sg)
   attach(sg_ns3)
   ns3_err = summarySE(sg_ns3, measurevar="ElapsedSecns3", groupvars=c("LinkSize"))
   sg_err = summarySE(sg_ns3, measurevar="ElapsedSecsg", groupvars=c("LinkSize"))

sg_err

#+END_SRC
#+RESULTS:
:   LinkSize  N ElapsedSecsg          sd       se          ci
: 1        1 10        0.033 0.009486833 0.003000 0.006786471
: 2        2 10        0.030 0.000000000 0.000000 0.000000000
: 3        4 10        0.041 0.034785054 0.011000 0.024883729
: 4        6  4        0.355 0.203387971 0.101694 0.323635648
...
<<format_theme>>
   ...
   ylab(label="Peak Memory Usage in Kbytes")+
   xlab(label="Number of Links between SRC and DST nodes")+
   scale_colour_Publication()+
   theme_Publication()
#+END_SRC
