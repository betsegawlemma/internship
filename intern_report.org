...
**** Questions
     - Conditions for proposing power consumption modeling
       ...
       - In a data center the power consumption of network equipment is about [[https://research.google.com/pubs/pub32980.html][2%]] to [[http://ieeexplore.ieee.org/document/5072138/][15%]], therefore it can be safely ignored. However, I think at least the idle power consumption of 
         switches can be incorporated in SimGrid using the <link> tags which represent switches
...
***** Start implementing the model on SimGrid, if the proposed model is acknowledged 
* Development
