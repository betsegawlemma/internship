...
#+BEGIN_SRC R :results output :var validation=validation :exports both 
   ...
   attach(sg_ns3)
   t.test(TotalEnergy,SgTotalEnergy,paired=FALSE,conf.level=0.95)
  cat("Difference in percentage is:",(4837.196 - 5007.053)/100)
#+END_SRC
...
data:  TotalEnergy and SgTotalEnergy
t = -0.29664, df = 77.906, p-value = 0.7675
alternative hypothesis: true difference in means is not equal to 0
95 percent confidence interval:
 -1309.8343   970.1196
sample estimates:
...
Difference in percentage is: -1.69857
#+end_example
...
#+BEGIN_SRC R :results output :var validation=validation :exports both 
   ...
   attach(sg_ns3)
   t.test(TotalEnergy,SgTotalEnergy,paired=FALSE,conf.level=0.95)
  cat("Difference in percentage is:",(9672.555 - 10082.613)/100) 
#+END_SRC
...
data:  TotalEnergy and SgTotalEnergy
t = -0.3568, df = 77.865, p-value = 0.7222
alternative hypothesis: true difference in means is not equal to 0
95 percent confidence interval:
 -2698.139  1878.022
sample estimates:
...
Difference in percentage is: -4.10058
#+end_example

**** Experiment 13: Flow 1, Links 3 
#+BEGIN_SRC bash :results silent :exports both 
#! /bin/bash
RANDOM=234
cd ~/simgrid/examples/msg/energy-link
...
#+BEGIN_SRC R :results output :var validation=validation :exports both 
   ...
   attach(sg_ns3)
   t.test(TotalEnergy,SgTotalEnergy,paired=FALSE,conf.level=0.95)
   cat("Difference in percentage is:",(6804.928 - 7021.571)/100) 
#+END_SRC
...
data:  TotalEnergy and SgTotalEnergy
t = -0.42415, df = 85.896, p-value = 0.6725
alternative hypothesis: true difference in means is not equal to 0
95 percent confidence interval:
 -1232.0347   798.7495
sample estimates:
...
Difference in percentage is: -2.16643
#+end_example
...
#+BEGIN_SRC R :results output :var validation=validation :exports both 
   ...
   attach(sg_ns3)
   t.test(TotalEnergy,SgTotalEnergy,paired=FALSE,conf.level=0.95)
   cat("Difference in percentage is:",(2199.803 - 822.916)/100)
#+END_SRC
...
data:  TotalEnergy and SgTotalEnergy
t = 12.779, df = 78.058, p-value < 2.2e-16
alternative hypothesis: true difference in means is not equal to 0
95 percent confidence interval:
 1162.376 1591.397
sample estimates:
...
Difference in percentage is: 13.76887
#+end_example
...
#+BEGIN_SRC R :results output :var validation=validation :exports both 
   ...
   attach(sg_ns3)
   t.test(TotalEnergy,SgTotalEnergy,paired=FALSE,conf.level=0.95)
   cat("Difference in percentage is:",(7896.580 - 8211.788)/7896.50*100)
#+END_SRC
...
data:  TotalEnergy and SgTotalEnergy
t = -0.59747, df = 121.79, p-value = 0.5513
alternative hypothesis: true difference in means is not equal to 0
95 percent confidence interval:
 -1359.6030   729.1871
sample estimates:
...
Difference in percentage is: -3.991743
#+end_example
...
<<format_theme>>
   ...
   sg_ns3 = merge(ex16_ns3,ex16_sg, by=c("LinkSize"))
   attach(sg_ns3)
...
<<format_theme>>
   ...
   attach(sg_ns3)
   ggplot(sg_ns3,aes(x=LinkSize))+
   geom_point(aes(y = PeakMemns3, colour = "ECOFEN"),size=1.3)+
   geom_point(aes(y = PeakMemsg, colour = "SimGrid"),size=1.3)+
