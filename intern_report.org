...
#+CALL: extract_data(input_file="data/eco_val_modified_100.dat", output_file="data/eco_val_modified_100.csv",size=100) :exports both
- Extract data from file:data/eco_val_modified_576.dat
#+CALL: extract_data(input_file="data/eco_val_modified_576.dat", output_file="data/eco_val_modified_576.csv",size=576) : exports both
- Extract data from [[file:data/eco_val_modified_1000.dat]]
#+CALL: extract_data(input_file="data/eco_val_modified_1000.dat", output_file="data/eco_val_modified_1000.csv",size=1000) :exports both
- Extract data from [[file:data/eco_val_modified_1500.dat]]
#+CALL: extract_data(input_file="data/eco_val_modified_1500.dat", output_file="data/eco_val_modified_1500.csv",size=1500) :exports both
