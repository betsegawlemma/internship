...
//                                   AP
//                                  Wifi Edge 10.1.2.0
- NS3 [[file:ns3/wifi-nodes-energy-consumption.cc][script]] was written to setup such network
- This script displays the energy consumption of a single edge node 
- The left part nodes represent client nodes, each runs UdpEchoClient application
- The right part nodes represent edge nodes, each running UdpEchoServer application
...
#+BEGIN_SRC R  :results output graphics :file figures/epc.png :exports both  
...
packet is received
#+BEGIN_SRC R  :results output graphics :file figures/ep_interval.png :exports both  
...
#+BEGIN_SRC R  :results output graphics :file figures/ece.png :exports both  
