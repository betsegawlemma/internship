...
**** Experiment 14: Flow 2, Links 3
#+BEGIN_SRC bash :results silent :exports both 
#! /bin/bash
RANDOM=234
cd /media/betsegaw/Windows8_OS/simgrid/examples/msg/energy-link
for ((k=0; k<40; k++)); do
...
#+END_SRC 
**** Experiment: Confirming ecofen's data point resolution effect 
