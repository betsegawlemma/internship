...
*** TODO A Power Benchmarking Framework for Network Devices 
    ...
    specifies that the energy consumption of an equipment should directly correspond to the equipment load.
...
**** Questions
    ...
    - P_equipment_atLoad(t) is the instantaneous power consumed by the equipment at a given traffic load found from the ideal proportional line
