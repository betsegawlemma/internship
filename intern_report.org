...
***** Directly on from ECOFEN in NS-3, we used NS-3's bulk send tcp application with maximum bytes to send between 1 and 200 MBytes
#+BEGIN_SRC bash :results output :exports both
#! /bin/bash
...
t = -0.66541, df = 121.77, p-value = 0.507
alternative hypothesis: true difference in means is not equal to 0
95 percent confidence interval:
 -931.3336  462.7431
sample estimates:
