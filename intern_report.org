...
**** Questions
     ...
     - Questions
       ...
       - Do I really need to come up with a brand new model if this model gives reasonably accurate result?
**** Work Planned
***** Propose power consumption model for large-scale networks in the context of SimGrid
***** If the proposed model is acknowledged, start implementing the model for SimGrid 
* Development
