...
- Running [[file:ns3/validate_ecofen_complete.cc][new NS-3 script]] as shown in the shell code block below produces files: [[file:data/eco_val_complete_576.dat]] and
  [[file:data/eco_val_complete_1500.dat]] both of theses file are for the receiving end, and [[file:data/eco_val_complete_1000.dat]] is used for the sending
  end. 
#+BEGIN_SRC bash :results output :exports both
#! /bin/bash
cd ~/ns3workspace/source/ns-3.26
