...
As we have already discussed in Section~\ref{section:packetflow}, the advantages of flow-level simulation is scalability in terms of speed and memory usage. 
